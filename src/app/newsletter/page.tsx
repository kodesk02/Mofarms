...
export default function NewsLetter() {
  return (
    <div className="bg-gray-200">
      <div className="md:flex p-10 inline">
        <div className="md:w-1/2 flex md:items-start items-center md:justify-start justify-center font-light ">
          More Inquiries
        </div>
        ...
        <div className="md:w-1/2 md:items-start items-center md:justify-start justify-center flex flex-col">
          <span className="md:text-start text-center">
            Experience the magic of pets with Mofarms
          </span>
